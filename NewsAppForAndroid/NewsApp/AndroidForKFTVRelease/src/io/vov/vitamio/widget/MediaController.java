...
public class MediaController extends FrameLayout {
	...
	private void initControllerView(View v) {
		...
		if(mProgress==null)
		{
			Toast.makeText(mContext, "progress is hide ", Toast.LENGTH_LONG).show();
		}
		if (mProgress != null) {
...
//				Toast.makeText(mContext, "progress is show ", Toast.LENGTH_LONG).show();
//				System.out.println("progress is running");
			}
